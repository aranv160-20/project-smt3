<?php 
    ...
    $query ='UPDATE tbl_daftar_mahasiswa SET   
        ...
        // mengikat parameter
							...
							$stmt->bindParam(':jns_kelamin', $jns_kelamin);
        ...
        $stmt->execute([':id_daftar'=> $id_daftar, ':tanggal_daftar' => $tanggal_daftar, ':nama_pendaftar' =>$nama_pendaftar, ':jns_kelamin' => $jns_kelamin,
